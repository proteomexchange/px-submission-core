...
public class ProjectMetaData implements Serializable {
   ...
   */
  private final Set<String> projectTags = new HashSet<>();
   ...
   */
  private final Set<CvParam> massSpecExperimentMethods = new HashSet<>();
   ...
   */
  private final Set<String> reanalysisAccessions = new HashSet<>();

  /**
   * Internal RPXD references to previously submitted PXD accessions, optional.
   */
  private final Set<String> rpxdOriginalAccessions = new HashSet<>();
  ...
  public ProjectMetaData(String projectTitle,
                         ...
                         Set<String> rpxdOriginalAccessions) {
    ...
    if (rpxdOriginalAccessions != null) {
      this.rpxdOriginalAccessions.addAll(rpxdOriginalAccessions);
    }
  }
  ...
  public boolean isRpxd() {
    return rpxdOriginalAccessions.size() > 0;
  }
  ...
  public boolean hasRpxdOriginalPxAccessions() {
    return !rpxdOriginalAccessions.isEmpty();
  }
  ...
  public int getNumberOfRpxdOriginalPxAccessions() {
    return rpxdOriginalAccessions.size();
  }
  ...
  public boolean hasRpxdPriginalPxAccession(String px) {
    return rpxdOriginalAccessions.contains(px);
  }
  ...
  public Set<String> getRpxdOriginalAccessions() {
    return rpxdOriginalAccessions;
  }
  ...
  public void addRpxdOriginalPxAccessions(String... pxAccession) {
    rpxdOriginalAccessions.addAll(Arrays.asList(pxAccession));
  }
  ...
  public void removeRpxdOriginalPxAccessions(String ... pxAccession) {
    if (pxAccession != null) {
      rpxdOriginalAccessions.removeAll(Arrays.asList(pxAccession));
    }
  }
  ...
  public void clearRpxdOriginalPxAccessions() {
    this.rpxdOriginalAccessions.clear();
  }
  ...
  public boolean equals(Object o) {
    ...
    if (!rpxdOriginalAccessions.equals(that.rpxdOriginalAccessions)) return false;
    ...
    if (submitterContact != null ? !submitterContact.equals(that.submitterContact) : that.submitterContact != null)
      return false;
    return tissues.equals(that.tissues);
  }
  ...
  public int hashCode() {
    ...
    result = 31 * result + rpxdOriginalAccessions.hashCode();
    return result;
  }
